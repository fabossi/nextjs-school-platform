        ...
        <form className="flex flex-col gap-4" onSubmit={onSubmit}>
            ...
            <div className="flex justify-between flex-wrap gap-2">
                ...
                <div className="flex flex-col gap-4 w-full md:w-1/4">
                    ...
                    <select className="ring-[1.5px] ring-gray-300 p-2 rounded-md text-sm w-full" defaultValue={data?.sex}
                        {...register("sex")}>
                ...
                <div className="flex flex-col gap-4 w-full md:w-1/4 justify-center relative top-3 ">
                    <label
            ...
            <button className="bg-blue-400 w-1/4 self-center text-white p-2 rounded-md">{type === "create" ? "Create" : "Update"}</button>
        </form>
    )
}
