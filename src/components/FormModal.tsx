...
const FormModal = ({ table, type, data, id }: {
    ...
    const bgColor = type === "create" ? "bg-fabossiYellow" : type === "update" ? "bg-fabossiSky" : "bg-fabossiPurple";
    const [open, setOpen] = useState(false);

    const Form = () => {
        return type === "delete" && id ?
            <form action='' className="p-4 flex flex-col gap-4">
                <span className="text-center font-medium">All data will be lost. Are you sure you want to delete this <b>{table}</b>?</span>
